...
- [Entorno de desarrollo](01-entorno.md)
- [Arquitectura inicial](02-arquitectura.md)
- [Base de datos Neon](03-neon.md)
...
OpenSpec se usara para requisitos, propuestas de cambio y validaciones formales.

La carpeta `docs/` se usara para explicaciones, decisiones, guias de instalacion y notas de aprendizaje.
